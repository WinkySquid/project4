...
public class Window {
	...
	/*
	 * This method displays an input dialog box with msg as the message inside the box.
	 */
	...
	/*
	 * This method displays an option dialog box (with no title) with the buttons inside the dialog box
